      ...
      <div className="flex w-full flex-col items-center">
        ...
        <div className="w-full max-w-[25rem] sm:max-w-[35rem] rounded-lg bg-white p-4 shadow-xl mt-6 sm:p-6">
          ...
          <div className="mt-5 flex flex-col gap-4 px-2">
            ...
            />
            <button className="mt-3 mb-1 h-11 w-full rounded-md bg-customGreen text-white transition-all duration-500 hover:bg-green-600 hover:shadow-lg active:scale-95 sm:text-lg">
              Sign In
            </button>
          </div>
        </div>
